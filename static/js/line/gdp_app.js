...
var parseTime = d3.timeParse("%Y");
  ...
  gdp_data.forEach(function(data) {
  ...
  var xTimeScale = d3.scaleTime()
    .domain(d3.extent(gdp_data, d => d.year))
    .range([0, width]);

  var yLinearScale = d3.scaleLinear().range([height, 0]);

  var chinaMax = d3.max(gdp_data, d => d.china);

  var unitedstatesMax = d3.max(gdp_data, d => d.united_states);

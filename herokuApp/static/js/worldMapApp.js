...
function markerSizeGDP(gdp) {
  return gdp/1000000;
};

function markerSizePopulation(popualation) {
  return population/1000;
};

function markerSizeTradeBalance(trade_balance) {
  return trade_balance/1000;
};

function markerSizeImport(import_value) {
  return import_value/10000;
};

function markerSizeExport(export_value) {
  return export_value/10000;
}
...
// Facters Markers
var url = server_url + "/api/mapData";

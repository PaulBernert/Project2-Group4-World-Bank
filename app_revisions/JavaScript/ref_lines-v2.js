...
function createDataSet(){
    ...
    var chart_selection = data.filter(data => data.reporter_name === ctry.value && data.year === yr.value && data.indicator == ind.value)
    ...
    pbody.selectAll("h3").remove();
    pbody.append("h3").text(`Country: ${info_box[0].reporter_name}`); 
    pbody.append("h3").text(`Total Import Value: ${info_box[0].total_dollars}`);
    pbody.append("h3").text(`Total Export Value: ${info_box[1].total_dollars}`);
    ...
    chart_selection.forEach(function(data){
